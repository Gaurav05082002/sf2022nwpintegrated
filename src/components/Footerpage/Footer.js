    ...
    return (
        <section className="Footer">
            ...
            <div className="footer-credits-container">
                ...
                <h1 id="trigger">Website Credits<br/></h1>
            ...
            <div className="footer-credits-links"><a target="_blank" href="https://www.facebook.com/springfest.iitkgp" className="fa fa-facebook"/><a target="_blank" href="https://www.instagram.com/iitkgp.springfest/?hl=en" className="fa fa-instagram"/></div>
            </div>
